        ...
        <div className=" py-12 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-20 xl:pr-12 ml-auto">
          <div className="max-w-lg mx-auto">
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              ...
              Want to have a quick chat or grab a coffee? Feel free to connect
              with me on LinkedIn, send me an email or contact me via the form.
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  <LocationMarkerIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">Sydney, NSW</span>
                </dd>
              </div>
            </dl>
          </div>
